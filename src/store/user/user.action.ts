...
export type GoogleSignInStart = Action<USER_ACTION_TYPES.GOOGLE_SIGN_IS_START>
...
export const googlSignInStart = withMatcher((): GoogleSignInStart => createAction(USER_ACTION_TYPES.GOOGLE_SIGN_IS_START))
